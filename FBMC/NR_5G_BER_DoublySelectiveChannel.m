...
fprintf('WOLA           |%17.2f  |%8.2f MHz  |%8.2f ms  |%8.2f Mbit/s  | \n', WOLA.PHY.TimeSpacing*WOLA.PHY.SubcarrierSpacing   , WOLA.PHY.SubcarrierSpacing*WOLA.Nr.Subcarriers/1e6   , WOLA.PHY.TimeSpacing*WOLA.Nr.MCSymbols/1e-3   , length(DetectedBitStream_OneTapEqualizer_OFDM)/(WOLA.PHY.TimeSpacing*WOLA.Nr.MCSymbols)/1e6   );
fprintf('FOFDM          |%17.2f  |%8.2f MHz  |%8.2f ms  |%8.2f Mbit/s  | \n', FOFDM.PHY.TimeSpacing*FOFDM.PHY.SubcarrierSpacing , FOFDM.PHY.SubcarrierSpacing*FOFDM.Nr.Subcarriers/1e6 , FOFDM.PHY.TimeSpacing*FOFDM.Nr.MCSymbols/1e-3 , length(DetectedBitStream_OneTapEqualizer_OFDM)/(FOFDM.PHY.TimeSpacing*FOFDM.Nr.MCSymbols)/1e6 );
fprintf('UFMC           |%17.2f  |%8.2f MHz  |%8.2f ms  |%8.2f Mbit/s  | \n', UFMC.PHY.TimeSpacing*UFMC.PHY.SubcarrierSpacing   , UFMC.PHY.SubcarrierSpacing*UFMC.Nr.Subcarriers/1e6   , UFMC.PHY.TimeSpacing*UFMC.Nr.MCSymbols/1e-3   , length(DetectedBitStream_OneTapEqualizer_OFDM)/(UFMC.PHY.TimeSpacing*UFMC.Nr.MCSymbols)/1e6   );
fprintf('===========================================================================================\n');
fprintf('===========================================================================================\n');
